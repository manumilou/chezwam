...
_magic_number = 5
_modified_time = 1284951710.186188
_template_filename='/home/remix/dev/ChezWam/chezwam/templates/derived/section/new.html'
_template_uri='/derived/section/new.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\n\n')
        # SOURCE LINE 8
        __M_writer(escape(h.form_start(h.url_for(controller='section', action='create'), method="post")))
        __M_writer(u'\n    ')
        # SOURCE LINE 9
        __M_writer(escape(fields.body()))
        __M_writer(u'\n    ')
        # SOURCE LINE 10
        __M_writer(escape(h.field(field=h.submit(value="Create Section", name='submit'))))
        __M_writer(u'\n')
        # SOURCE LINE 11
...
def render_heading(context):
    ...
    try:
        ...
        __M_writer = context.writer()
        # SOURCE LINE 4
        __M_writer(u'\n    <h1 class="main">Create a New Section</h1>\n')
        return ''
    finally:
        context.caller_stack._pop_frame()
