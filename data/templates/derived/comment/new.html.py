...
_magic_number = 5
_modified_time = 1284952161.0205851
_template_filename='/home/remix/dev/ChezWam/chezwam/templates/derived/comment/new.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\n\n')
        # SOURCE LINE 8
        __M_writer(escape(h.form_start(h.url_for(pageid=c.page.id, controller='comment', action='create'), method="post")))
        __M_writer(u'\n    ')
        # SOURCE LINE 9
